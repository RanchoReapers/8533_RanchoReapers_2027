...
| ![5](https://img.shields.io/badge/_-FFFF00?style=for-the-badge) Yellow and ![7](https://img.shields.io/badge/_-FFFFFF?style=for-the-badge) White | Flashing | when CONNECTED to an FMS and in TELEOP | The robot's ALLIANCE HUB will SWITCH STATES (active/inactive) within FIVE SECONDS. |
| ![6](https://img.shields.io/badge/_-FFFFFF?style=for-the-badge) White | Solid | when CONNECTED to an FMS and in TELEOP | The robot's ALLIANCE HUB is INACTIVE or the data for the robot's HUB STATE did not send properly. |
